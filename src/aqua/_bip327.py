# Vendored MuSig2 (BIP-327) reference implementation.
#
# Source: https://github.com/bitcoin/bips/blob/master/bip-0327/reference.py
# License: BSD-3-Clause (same as BIP-327).
#
...
# with ephemeral, per-swap refund keys (see docs/submarine-swap-ln-refund.md).
#
# ruff: noqa
# fmt: off
